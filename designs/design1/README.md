...
[All designs](../../README.md) · [Gallery](index.html) · [Finished cards](cards/)
...
to this design folder (`designs/design1/`):

```python
import json
from pathlib import Path

root = Path("/path/to/playing-cards/designs/design1")
...
Run these commands from `designs/design1/`:
...
To reproduce the French-suited faces and backs from saved components:

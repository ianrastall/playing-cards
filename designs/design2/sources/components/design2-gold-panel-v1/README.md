...
`foliage-color-mask.png` records the feathered green selection used for the
olive-leaf adjustment. The exporter changes color channels in place, excluding
the central and satellite medallions. It leaves the field and border masks
unchanged. European Standard inherits the adjustment through its Bridge source.
